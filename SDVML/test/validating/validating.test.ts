...
import { createSdvmlServices } from '../../src/language/sdvml-module.js';
import { Model, isModel } from '../../src/language/generated/ast.js';

let services: ReturnType<typeof createSdvmlServices>;
let parse: ReturnType<typeof parseHelper<Model>>;
let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
    services = createSdvmlServices(EmptyFileSystem);
    const doParse = parseHelper<Model>(services.Sdvml);
