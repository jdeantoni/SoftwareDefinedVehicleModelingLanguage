...
export async function startDiagram(context) {
    ...
    const sdvmlDiagramEditorProvider = vscode.window.registerCustomEditorProvider('sdvml.glspDiagram', new SDVMLEditorProvider(context, glspVscodeConnector), {
...
//# sourceMappingURL=diagram-starter.js.map