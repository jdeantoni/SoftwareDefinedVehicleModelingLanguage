...
connection.onRequest('modelRequest', async (params) => {
	...
	if (entryDocument) {
		...
		connection.sendNotification(new NotificationType<DocumentChange>('node/DocumentChangeOnRequestToSDVMLDiagram'), {
...
shared.workspace.DocumentBuilder.onBuildPhase(DocumentState.Validated, (documents) => {
    ...
    connection.sendNotification(new NotificationType<DocumentChange>('node/DocumentChangeToSDVMLDiagram'), {
		uri: sdvmlUris,
